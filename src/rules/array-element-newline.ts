...
export default ESLintUtils.RuleCreator.withoutDocs({
    ...
    create(context) {
         ...
         */
        function normalizeOptionValue(providedOption: any) {
         ...
         * @returns {void}
         */
        function reportNoLineBreak(token: TSESTree.Token) {
            ...
            context.report({
                ...
                fix(fixer) {
                    ...
                    if (!twoTokensBefore || ASTUtils.isCommentToken(twoTokensBefore)) {
                        return null;
                    }
         ...
         */
        function reportRequiredLineBreak(token: TSESTree.Token) {
            const tokenBefore = sourceCode.getTokenBefore(token, {
                includeComments: true,
            });
        ...
        function check(node: TSESTree.Node) {
            ...
            elements.forEach((element: any, i: number) => {
                ...
                if (options.bracesSameLine && ASTUtils.isOpeningBraceToken(maybeOpenBraceToken)) {
                    ...
                    if (ASTUtils.isTokenOnSameLine(maybeCloseBraceToken, maybeOpenBraceToken)) {
